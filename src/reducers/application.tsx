...
const reducer = (state: State, action: Action): State => {
  switch(action.type) {
    case 'set_active':
      return minimizeAllOthers({ ...state, [action.applicationName]: { ...state[action.applicationName], state: 'focused' } }, action.applicationName);
    case 'minimize':
      return { ...state, [action.applicationName]: { ...state[action.applicationName], state: 'minimized' }};
    case 'add':
      return minimizeAllOthers({ ...state, [action.applicationName]: { component: action.component, state: 'focused' } }, action.applicationName);
  }
}
