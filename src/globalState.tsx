...
export const setUser = (dispatch: Dispatch<GlobalAction>, user?: User | null) => {
    dispatch({ type: GlobalActionTypes.SET_USER, payload: user });
};
...
export const addToCart = (dispatch: Dispatch<GlobalAction>, id: number) => {
    dispatch({ type: GlobalActionTypes.ADD_TO_CART, payload: id });
};
export const removeFromCart = (dispatch: Dispatch<GlobalAction>, id: number) => {
    dispatch({ type: GlobalActionTypes.REMOVE_FROM_CART, payload: id });
};
